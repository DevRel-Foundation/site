...
// Returns a list of job categories with their descriptions.
export async function getJobCategories() {
  const schema = await getToolsSchema();
  // The categories are defined in $defs as category-*
...
// Returns a list of job outcomes with their descriptions.
...
// Returns a list of job motivations with their descriptions.
...
// Returns a list of job situations with their descriptions.
