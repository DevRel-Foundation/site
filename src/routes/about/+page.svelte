	...
	<section class="team-section">
		...
		<div class="team-grid">
			<BioSteeringCommittee
				name="Ana Jiménez"
				title="LF engagements, website, PM, advocacy"
